...
<div class="container borde_superior_grilla">
  <div class="grilla">
    ...
    <div>
      <h1>
        En <strong>CECHRIZA SAC</strong>, impulsamos la eficiencia en la gestión de efectivo con equipos de alta tecnología, procesos seguros y atención especializada en todo el Perú.
      </h1>
    </div>
    ...
    <div class="grid_boletin">
      <div class="item_boletin">
        <div class="contenedor_boletin">
          ...
          <h6 class="text-sm mt-2">
            En CECHRIZA garantizamos la calidad de nuestros equipos y servicios. Cada producto cuenta con respaldo técnico y cobertura postventa que asegura su correcto funcionamiento desde el primer día.
          </h6>
          <p>
      ...
      <div class="item_boletin">
        <div class="contenedor_boletin">
          ...
          <h6 class="text-sm mt-2">
            Apostamos por la tecnología más avanzada del mercado para ofrecer soluciones modernas, eficientes y adaptadas a las necesidades reales de nuestros clientes.
          </h6>
          <p>
            <i class="fa fa-angle-right" aria-hidden="true"></i> Equipos con sistemas inteligentes y conectividad total.
          </p>
        </div>
      </div>
      ...
      <div class="item_boletin">
        <div class="contenedor_boletin">
          ...
          <h6 class="text-sm mt-2">
            Nuestro compromiso es brindar asesoría honesta, información clara y procesos abiertos. Nos enfocamos en construir relaciones duraderas basadas en la confianza y la responsabilidad.
          </h6>
          <p>
            <i class="fa fa-angle-right" aria-hidden="true"></i> Comunicación directa y asesoría personalizada en cada etapa.
          </p>
        </div>
      </div>
    </div>
...
<section class="py-12 px-4 text-center  seccion_boletin">
  ...
  <p class="description">
    Recibe noticias, promociones y las últimas novedades sobre nuestros equipos de conteo, detección y mantenimiento técnico.
  </p>
  ...
  <div class="container">
    <div class="grid_mantenimiento">
      ...
      <div>
        ...
        <p>En CECHRIZA brindamos mantenimiento preventivo y correctivo para asegurar el óptimo funcionamiento de tus equipos. Nuestro equipo técnico capacitado garantiza intervenciones seguras, rápidas y eficientes.</p>
        <ul>
